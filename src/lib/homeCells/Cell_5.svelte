<script lang="ts">
    ...
    const img_url = api_url + data.Photo_bloc_1.data.attributes.url
</script>

<div class="cell-5 overflow-hidden zoom-img-bg main-radius has-link-arrow relative">
    ...
    <img id="img-bg" class="w-full main-radius" src={img_url} alt="">
</div>